...
def parse_args():
   ...
   parser.add_argument('--src', dest='imgtxt', help='the src', type=str, default='./roi_img/')
...
def start_test(model_proto,model_weight,img_folder,testsize,enable_crop):
   caffe.set_device(0)
   #caffe.set_mode_cpu()
   ...
   for imgname in img_list:
      ...
      if imgtype != 'png' and imgtype != 'jpg' and imgtype != 'JPG' and imgtype != 'jpeg' and imgtype != 'tif' and imgtype != 'bmp':
          print (imgtype,"error")
          continue
      imgpath = "../modules/classification/roi_img/" + imgname
